...
import { IUserRepository } from '../repositories/IUser.repository'; // Import IUserRepository
import { CreateTransactionSchema, UpdateTransactionSchema } from '../validations';
import { TransactionInput } from '@/types/finance'; // Assumindo que TransactionInput inclui userId


export class TransactionService {
  constructor(
    private readonly transactionRepository: ITransactionRepository,
    private readonly userRepository: IUserRepository // Inject IUserRepository
  ) {}
